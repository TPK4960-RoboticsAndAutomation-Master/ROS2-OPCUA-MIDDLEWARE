...
public class LbrCommander extends Node{
	...
	public LbrCommander(String remote_ip, int port,LBR robot, String ConnectionType, AbstractFrame drivepos) {
		super(remote_ip, port, ConnectionType, "LBR commander");
			...
			double jointAngle;
				if(jointIndex==-1){ // A10: Stop all
				 ...
				 // A9: Move to driveposition
					System.out.println("kom til A9!");
					if(getisLBRMoving()){
						System.out.println("Program registrerte movement! Cancelling");
						currentmotion.cancel();
					}
					...
					System.out.println("Else skjedde, aka feil syntax eller AX != A9 != A10");
